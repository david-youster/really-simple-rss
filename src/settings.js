...
const Settings = {
  ...
  async _initPage() {
    ...
    const swapDisplaysDisabledRadio = document.getElementById('swapDisplaysDisabledRadio');
    const swapDisplaysEnabledRadio = document.getElementById('swapDisplaysEnabledRadio');
